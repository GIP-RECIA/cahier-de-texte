...
/**
 * Classe à laquelle fait appel ImportEDTFacadeService pour les méthodes d'accès aux données.
 *
 * @author jp.mandrick
 * @version $Revision: 1.1 $
  */
public interface ImportEDTFacadeService {
    ...
    /**
     * Edition PDF.
     * @param printEDTDTO le DTO avec les infos du rapport.
     * @return the report
     */
